...
public class ITPanelMenu {
    ...
    private static void addDisabledMenuGroupPage(FrameworkDeployment deployment) {
        ...
        p.form("        <rich:panelMenuItem id='disabledMenu' label='Item 2' styleClass='disabled' name='Item_2' action='#{panelMenuBean.doAction}'  />");
        p.form("    </rich:panelMenuGroup> ");
        p.form("</rich:panelMenu>");
    ...
    private static void addDisabledMenuPage(FrameworkDeployment deployment) {
        ...
        p.form("<rich:panelMenu id='enabledMenu' itemMode='ajax' groupMode='ajax'>");
        p.form("    <rich:panelMenuGroup label='Group 1' expanded='true'> ");
        p.form("        <rich:panelMenuItem label='Item 1' styleClass='enabled' name='Item_1' action='#{panelMenuBean.doAction}'  />");
        p.form("    </rich:panelMenuGroup> ");
        p.form("</rich:panelMenu>");
        ...
        p.form("        <rich:panelMenuItem id='disabledMenuItem' label='Item 2' styleClass='disabled' name='Item_2' action='#{panelMenuBean.doAction}'  />");
        p.form("    </rich:panelMenuGroup> ");
        p.form("</rich:panelMenu>");
