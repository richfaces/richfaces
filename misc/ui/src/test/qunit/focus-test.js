...
test("sortTabindexNums", function() {
    var sortTabindexNums = RichFaces.ui.FocusManager.__fn['sortTabindexNums'];
...
test("searchCommonParent", function() {
    var searchCommonParent = RichFaces.ui.FocusManager.__fn['searchCommonParent'];
...
test("sortByDOMOrder", function() {
    var sortByDOMOrder = RichFaces.ui.FocusManager.__fn['sortByDOMOrder'];
...
test("sortTabindex", function() {
    var sortTabindex = RichFaces.ui.FocusManager.__fn['sortTabindex'];
