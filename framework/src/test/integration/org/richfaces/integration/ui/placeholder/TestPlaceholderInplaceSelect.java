 ...
 */
package org.richfaces.integration.ui.placeholder;
...
public class TestPlaceholderInplaceSelect extends AbstractPlaceholderTest {
    ...
    public static WebArchive createDeployment() {
        ...
        p.body("<r:inplaceSelect id='input'>");
        ...
        p.body("<r:inplaceSelect id='input' defaultLabel='#{not empty param.defaultLabel ? param.defaultLabel : null}' >");
