 ...
 */
@JsfComponent(tag = @Tag(name = "repeat", handlerClass = RepeatHandler.class, type = TagType.Facelets), renderer = @JsfRenderer(type = "org.richfaces.ui.RepeatRenderer"), attributes = {
