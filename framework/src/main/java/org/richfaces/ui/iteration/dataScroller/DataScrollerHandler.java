...
import org.richfaces.ui.iteration.dataTable.MethodExpressionScrollListener;
...
public class DataScrollerHandler extends ComponentHandler {
    ...
    private static final class ScrollListenerMapper extends Metadata {
        private static final Class[] SIGNATURE = new Class[] { org.richfaces.ui.iteration.dataScroller.DataScrollEvent.class };
