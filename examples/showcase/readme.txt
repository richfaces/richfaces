========================================================================
                      ...
                      RichFaces - Ajax enabled JSF 2.0 component library
                                       ...
                                       RichFaces 5.0.0-SNAPSHOT SHOWCASE
                                                    http://richfaces.org
                                                              March 2011
...
were not mobile ready. For example, r:tooltip, r:extendedDataTable,
r:jquery, and r:popupPanel either did not make sense in a mobile
environment or needed a heavy rewrite for touch interfaces.
r:dragDrop however, does work on iOS� Mobile Safari, but not on Android.
To use r:dragDrop in Mobile Safari browsers, you can include this snippet
of JavaScript
