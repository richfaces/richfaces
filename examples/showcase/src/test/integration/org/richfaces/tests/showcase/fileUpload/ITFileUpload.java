 ...
 * @version $Revision$
 */
public class ITFileUpload extends AbstractWebDriverTest {
    ...
    public void testThereAreAllRequiredElements() {
        ...
        assertEquals("The message that no files is currently uploaded should be there!",
            page.getDivWithUploadFilesMessage().getText(), MSG_NO_FILES);
