 ...
 * @version $Revision$
 */
public class ITSelectsUpdates extends AbstractWebDriverTest {
...
//        assertFalse(secondSelect.isDisplayed(), "Second select should be dispayed");
        ...
        assertEquals("When selected fruits in first select, in the second "
            + "should be some examples of Fruits", fruitsExpected, fruitsActual);
        ...
        assertEquals("When selected vegetables in first select, in the second "
            + "should be some examples of vegetables", vegetablesExpected, vegetablesActual);
