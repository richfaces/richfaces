 ...
 * @version $Revision$
 */
public class ITParam extends AbstractWebDriverTest {
    ...
    public void testClickToButtonAndCheckTheSelectedName() {
        ...
        for (ParamPage.Name name : ParamPage.Name.getAll()) {
            page.setName(name);
            Graphene.waitAjax().until("After selecting name, the output should contain the name.").element(page.output).text()
