 ...
 * @version $Revision$
 */
public class ITPushCdi extends AbstractWebDriverTest {
    ...
    private void checkExpectedMessagesOnConsumers(Map<Integer, String> consumersWindows) {
        ...
        for (Map.Entry<Integer, String> entry : consumersWindows.entrySet()) {
            ...
            assertEquals("The window invoked in the order as " + key
                + " should contains different messages", actualMessage, expectedMessages);
        }
    }
