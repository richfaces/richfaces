 ...
 * @version $Revision$
 */
public class ITSimple extends ITUsage {
    ...
    public void testSubmitButtonAndAjaxRequestProgress() {
        ...
        assertProgressPictureAppearsOnAjaxRequest(page.progressImage);
        assertEquals("There should appear notification that user stored successfully!", page.output.getText(), "User a stored successfully");
    }
}
