 ...
 * @version $Revision$
 */
public class ITToolBar extends AbstractWebDriverTest {

//    private final String CONTEXT = "/showcase/images/icons";
    private final String[] EXPECTED_ELEMENTS = { "create_doc.gif", "create_folder.gif",
            "copy.gif", "save.gif", "save_as.gif", "save_all.gif" };
    ...
    public void testAllExpectedElementsPresention() {
        for (WebElement image : page.toolbarImages) {
            ...
            if (!runInPortalEnv) {
                //the src attribute is in format: context/images/icons/***.gif;jsonid=12345
                src = src.split(";")[0];
