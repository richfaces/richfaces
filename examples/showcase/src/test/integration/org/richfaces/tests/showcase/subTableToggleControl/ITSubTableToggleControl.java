 ...
 * @version $Revision$
 */
public class ITSubTableToggleControl extends AbstractDataIterationWithCars {
    ...
    private void checksCountingOfRows(WebElement toggler, WebElement bodyOfTable) {
        ...
        assertEquals("The information about total rows is incorrect!", expectedNumberOfTrsInt, numberOfVisibleTrs - 1);
    }
    ...
    private void checkTogglersFunctionality(WebElement toggler, WebElement subtable) {
        ...
        assertEquals("The subtable should be displayed, or hidden, "
            ...
            isSubTableDisplayedAfterFirstClick, !isSubTableDisplayedAfterSecondClick);
    }
}
