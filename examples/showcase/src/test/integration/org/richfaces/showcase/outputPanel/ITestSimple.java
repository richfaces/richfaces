...
public class ITestSimple extends AbstractWebDriverTest {
    ...
    public void testFirstCorrectInput() {
        ...
        Graphene
            ...
            .element(page.firstOutput).is().present();
    ...
    public void testFirstWrongInput() {
        ...
        Graphene
            ...
            .element(page.firstError).is().present();
        Graphene.waitAjax()
