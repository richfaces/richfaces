INSERT INTO User(id, fbId, firstname, secondname, email, login, passwordHash, birthdate, sex, hasAvatar, preDefined) VALUES (1,  '1', 'Andrey', 'Markhel', 'amarkhel@exadel.com',  'amarkhel',       '8cb2237d0679ca88db6464eac60da96345513964',  '1985-01-08', 0, false, true);
INSERT INTO User(id, fbId, firstname, secondname, email, login, passwordHash, birthdate, sex, hasAvatar, preDefined) VALUES (2,  '1', 'Nick',   'Curtis',  'nkurtis@iba.com',      'Viking',         '8cb2237d0679ca88db6464eac60da96345513964',  '1978-01-08', 1, false, true);
INSERT INTO User(id, fbId, firstname, secondname, email, login, passwordHash, birthdate, sex, hasAvatar, preDefined) VALUES (3,  '1', 'John',   'Smith',   'jsmith@jboss.com',     'Noname',         '8cb2237d0679ca88db6464eac60da96345513964',  '1970-01-08', 1, false, true);

INSERT INTO User(id, fbId, firstname, secondname, email, login, passwordHash, birthdate, sex, hasAvatar, preDefined) VALUES (10, '1', 'John',   'Smith',   'jsmith_10@jboss.com',     'user_for_add',   '8cb2237d0679ca88db6464eac60da96345513964',  '1970-01-08', 1, false, false);
INSERT INTO User(id, fbId, firstname, secondname, email, login, passwordHash, birthdate, sex, hasAvatar, preDefined) VALUES (11, '1', 'John',   'Smith',   'jsmith_11@jboss.com',     'user_for_del',   '8cb2237d0679ca88db6464eac60da96345513964',  '1970-01-08', 1, false, false);
INSERT INTO User(id, fbId, firstname, secondname, email, login, passwordHash, birthdate, sex, hasAvatar, preDefined) VALUES (12, '1', 'John',   'Smith',   'jsmith_12@jboss.com',     'user_for_dnd',  '8cb2237d0679ca88db6464eac60da96345513964',  '1970-01-08', 1, false, false);
