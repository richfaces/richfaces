...
public class NotifyStackRenderer extends RendererBase {
    ...
    public void encodeBegin(FacesContext context, UIComponent component) throws IOException {
        ...
        writer.writeText(
                new JSFunction("RichFaces.ui.NotifyStack.register", RendererUtils.getInstance().clientId(context, component),
                        getOptions((AbstractNotifyStack) component)), null);
    ...
    protected Map<String, Object> getOptions(AbstractNotifyStack stack) throws IOException {
        ...
        addOptionIfSet("position", stack.getPosition(), options);
        addOptionIfSet("direction", stack.getDirection(), options);
        addOptionIfSet("method", stack.getMethod(), options);
        return options;
    }
