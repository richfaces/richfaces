			...
			<table cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td>
						...
						<h:inputText  id="loginName" value="#{user.login}" styleClass="reg-table-input"/><h:outputText styleClass="required" value="*"/>
						</h:panelGroup>
						<h:panelGroup rendered="#{user.id != null}">
					...
					<td>
						<rich:messages  for="loginName" styleClass="required"/>
					</td>
				...
				<h:panelGroup rendered="#{user.id == null}">
					...
					<td>
						...
						<h:inputSecret required="true" id="password" value="#{user.password}" styleClass="reg-table-input"/><h:outputText styleClass="required" value="*"/>
					
					</td>
					<td>
						<rich:messages  for="password" styleClass="required"/>
					</td>
					</h:panelGroup>
				</tr>
				<tr>
				<h:panelGroup rendered="#{user.id == null}">
					...
					<td>
					<h:panelGroup rendered="#{user.id == null}">
						<h:inputSecret required="true" id="confirmPassword" value="#{user.confirmPassword}" styleClass="reg-table-input"/><h:outputText styleClass="required" value="*"/>
					</h:panelGroup>
						
					</td>
					<td>
						<rich:messages  for="confirmPassword" styleClass="required"/>
					</td>
					</h:panelGroup>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<h:inputText  id="firstname" value="#{user.firstName}" styleClass="reg-table-input"/><h:outputText styleClass="required" value="*"/>
					</td>
					<td>
						<rich:messages  for="firstname" styleClass="required"/>
				...
				<tr>
					...
					<td>
						<h:inputText  id="secondname" value="#{user.secondName}" styleClass="reg-table-input"/><h:outputText styleClass="required" value="*"/>
					</td>
					<td>
						<rich:messages  for="secondname" styleClass="required"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<rich:messages  for="sex" styleClass="required"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<rich:messages  for="birthDate" styleClass="required"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<h:inputText  id="email" value="#{user.email}" styleClass="reg-table-input"/><h:outputText styleClass="required" value="*"/>
					</td>
					<td>
						<rich:messages  for="email" styleClass="required"/>
