...
public class StylesheetRenderer extends ScriptStyleBaseRenderer {
    ...
    public void encodeEnd(FacesContext context, UIComponent component)
        ...
        // Ensure this stylesheet is not rendered more than once per request (based on resource name and library)
        ...
        // Ensure this stylesheet is not rendered more than once per request (based on request path)
        if (resourceUrl != null) {
            if (contextMap.containsKey(resourceUrl)) {
                return;
            } else {
                contextMap.put(resourceUrl, Boolean.TRUE);
            }
        }
